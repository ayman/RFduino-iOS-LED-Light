...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationWillResignActive(application: UIApplication) {
        ...
        // begins the transition to the background state.  Use this
        // method to pause ongoing tasks, disable timers, and throttle
        // down OpenGL ES frame rates. Games should use this method to
        // pause the game.
    }
    ...
    func applicationDidEnterBackground(application: UIApplication) {
        ...
        // state in case it is terminated later.  If your application
